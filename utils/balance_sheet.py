# balance_sheet.py - Demonstrating insurance company balance sheet components
...
def demonstrate_balance_sheet():
    ...
    Shows how assets, liabilities, and capital are related and how they
    change with different loss ratios
    """
    # History tracking
    history = []
    ...
    def update_plot(loss_ratio=0.65):
        ...
        for i, (name, value) in enumerate(liabilities_plot.items()):
            if i == len(liabilities_plot) - 1:  # Capital item
                color = 'black'
            else:
                color = 'black'
