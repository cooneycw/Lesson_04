# law_of_large_numbers.py - Demonstrating how prediction improves with sample size
...
def demonstrate_law_of_large_numbers(true_probability=0.05):
    ...
    Parameters:
    - true_probability: The actual probability of an accident occurring (default: 0.05 or 5%)

    Returns:
    - Interactive visualization showing convergence to true probability
    """
    # History tracking
    history = []
